...
export const TABLE_SEEDS: TableSeed[] = [
  ...
  // ---------- direct_config 默认指令配置（code / ref_code 语义） ----------
  {
    ...
    rows: [
      ...
      ['sensor_offline_enabled', 'auto', '1',  '离线告警开关',       '1', '关:0|开:1',       null, null,  null, '18.8', 'control', null, null, 'string', '1'],
      ['sensor_offline_seconds', 'sensor_offline_enabled', '1', '离线判定(秒)', '2', null,     null, '86400','0',  '19',   'control', null, null, 'int',    '60'],
      ['device_sync_enabled',    'auto', '1',  '状态同步开关',       '1', '关:0|开:1',       null, null,  null, '19.5', 'control', null, null, 'string', '0'],
      ['device_sync_frames',     'device_sync_enabled', '1', '状态同步帧数', '2', null,        null, '100', '0',  '20',   'control', null, null, 'int',    '0'],
      ...
      ['pid_enabled',            'auto', '1',  'PID 控温开关',      '1', '关:0|开:1',       null, null,  null, '25',   'control', null, null, 'string', '0'],
      ['pid_target',             'pid_enabled', '1', 'PID 目标温度(°C)',   '2', null,              null, '100', '0',  '26',   'control', null, null, 'float',  '30'],
      ['pid_kp',                 'pid_enabled', '1', 'PID 比例系数',       '2', null,              null, '100', '0',  '27',   'control', null, null, 'float',  '4'],
      ['pid_ki',                 'pid_enabled', '1', 'PID 积分系数',       '2', null,              null, '100', '0',  '28',   'control', null, null, 'float',  '0.02'],
      ['pid_kd',                 'pid_enabled', '1', 'PID 微分系数',       '2', null,              null, '100', '0',  '29',   'control', null, null, 'float',  '0.5'],
      ['pid_cycle',              'pid_enabled', '1', 'PID 周期(秒)',       '2', null,              null, '3600','5',  '30',   'control', null, null, 'int',    '60'],
      ['pid_sensor',             'pid_enabled', '1', 'PID 检测传感器',     '5', '升温1:1|升温2:2', null, null,  null, '31',   'control', null, null, 'int',    '2'],
