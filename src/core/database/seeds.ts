...
export const TABLE_SEEDS: TableSeed[] = [
  ...
  // ---------- direct_config 默认指令配置（code / ref_code 语义） ----------
  {
    ...
    rows: [
      ...
      ['sensor_spike_frames',    'auto', '1',  '跳变帧数阈值',       '2', null,              null, '100', '0',  '21',   'control', null, null, 'int',    '0'],
      ['sensor_spike_temp',      'auto', '1',  '温度跳变阈值(°C)',   '2', null,              null, '100', '0',  '22',   'control', null, null, 'float',  '10'],
      ['sensor_spike_pressure',  'auto', '1',  '压力跳变阈值(kPa)',  '2', null,              null, '1000','0',  '23',   'control', null, null, 'float',  '20'],
      ['sensor_spike_flow',      'auto', '1',  '流量跳变阈值(L/min)', '2', null,              null, '1000','0',  '24',   'control', null, null, 'float',  '100'],
      ['pid_enabled',            'auto', '1',  'PID 控温开关',      '1', '关:0|开:1',       null, null,  null, '25',   'control', null, null, 'string', '0'],
      ['pid_target',             'auto', '1',  'PID 目标温度(°C)',   '2', null,              null, '100', '0',  '26',   'control', null, null, 'float',  '30'],
      ['pid_kp',                 'auto', '1',  'PID 比例系数',       '2', null,              null, '100', '0',  '27',   'control', null, null, 'float',  '4'],
      ['pid_ki',                 'auto', '1',  'PID 积分系数',       '2', null,              null, '100', '0',  '28',   'control', null, null, 'float',  '0.02'],
      ['pid_kd',                 'auto', '1',  'PID 微分系数',       '2', null,              null, '100', '0',  '29',   'control', null, null, 'float',  '0.5'],
      ['pid_cycle',              'auto', '1',  'PID 周期(秒)',       '2', null,              null, '3600','5',  '30',   'control', null, null, 'int',    '60'],
      ['pid_sensor',             'auto', '1',  'PID 检测传感器',     '5', '升温1:1|升温2:2', null, null,  null, '31',   'control', null, null, 'int',    '2'],
