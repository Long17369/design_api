...
export const TABLE_SEEDS: TableSeed[] = [
  // ---------- sensor_data 字段映射（field1..7） ----------
  {
    ...
    keyColumn: 'id',
    // id, f_name, db_name, p_name, api_name, unit, type, visible, chartable, invalid_value, mapping
    columns: [
      'id',
      'f_name',
      'db_name',
    ...
    // prettier-ignore
    rows: [
      [1,  'ID',       'id',     'id',        null,         '',      '1', '0', '0', null,       null],
      [2,  '设备编号', 'd_no',   'id',        'id',         '',      '1', '0', '0', null,       null],
      [3,  '进水温度', 'field1', 'wen_du1',   'temp_in',    '°C',    '1', '1', '1', '[6553.5]', null],
      [4,  '出水温度', 'field2', 'wen_du2',   'temp_out',   '°C',    '1', '1', '1', '[6553.5]', null],
      [5,  '加热开关', 'field3', 'jia_re',    'heat_Y1',    '',      '1', '0', '0', '[65535]',  '{"0":"关","1":"开"}'],
      [6,  '水泵状态', 'field4', 'shui_beng', 'water_Y2',   '',      '1', '0', '0', '[65535]',  '{"0":"关","1":"开"}'],
      [7,  '瞬时流量', 'field6', 'liu_liang2','flow_rate',  'L/min', '1', '1', '1', '[655.35]', null],
      [8,  '水流压力', 'field7', 'pressure',  'pressure',   'kPa',   '1', '1', '1', '[6553.5]', null],
      [9,  '数据时间', 'c_time', 'time',      'time',       '',      '1', '1', '0', null,       null],
      [10, '流量总计', 'field5', 'liu_liang1','liu_liang1', 'L',     '1', '0', '1', null,       null],
      [11, '水泵运行时长', 'field8', 'pump_run_time', 'pump_run_time', 's', '1', '0', '1', null, null],
      [12, '加热运行时长', 'field9', 'heat_run_time', 'heat_run_time', 's', '1', '0', '1', null, null],
    ],
  },
  ...
  // ---------- error_msg 字段映射（field1..3） ----------
  {
    ...
    rows: [
      [1, 'ID',       'id',     'id',     '', '1', '0', '0'],
      [2, '设备编号', 'd_no',   'd_no',   '', '1', '1', '0'],
      [3, '错误信息', 'field1', 'e_msg',  '', '1', '1', '0'],
      [4, '错误代码', 'field2', 'e_no',   '', '1', '1', '0'],
      [5, '错误类型', 'field3', 'type',   '', '1', '1', '0'],
      [6, '故障时间', 'c_time', 'c_time', '', '1', '1', '0'],
    ],
  },
